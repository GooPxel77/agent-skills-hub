export const translations = {
  zh: {
    ...
    // Submit
    "submit.title": "添加 Skill",
    "submit.subtitle": "输入 GitHub 仓库链接，审核通过后将在下次同步时加入收藏库",
    "submit.button": "提交",
    "submit.tabSkill": "添加技能",
    ...
    "faq.title": "常见问题",
    "faq.q1": "这是什么？",
    "faq.a1": "这是我的个人 Agent Skills 收藏库，自动从 GitHub 收集和评分 MCP 服务器、Claude 技能和 Agent 工具。每 8 小时自动更新。",
    "faq.q2": "质量评分是如何计算的？",
    "faq.a2": "质量评分基于 8 个维度：完整性、清晰度、具体性、示例质量、README 结构、Agent 适配度等，综合计算得出 0-100 的评分。",
    "faq.q3": "如何添加 Skill？",
    "faq.a3": "在首页底部「添加 Skill」区域提交 GitHub 仓库链接，在 Admin 后台审核通过后，下次同步时自动收录。也可以直接编辑 data/curated/*.txt 文件。",
  ...
  en: {
    ...
    // Submit
    "submit.title": "Add a Skill",
    "submit.subtitle": "Enter a GitHub repo URL. It will be added to your collection after approval and next sync",
    "submit.button": "Submit",
    "submit.tabSkill": "Add Skill",
    ...
    "faq.title": "FAQ",
    "faq.q1": "What is this?",
    "faq.a1": "My personal Agent Skills collection, auto-synced from GitHub. It collects and scores MCP servers, Claude skills, and agent tools every 8 hours.",
    "faq.q2": "How are quality scores calculated?",
    "faq.a2": "Based on 8 dimensions: completeness, clarity, specificity, examples, README structure, agent readiness, etc. Each weighted differently to produce a 0-100 composite score.",
    "faq.q3": "How do I add a skill?",
    "faq.a3": "Use the 'Add a Skill' section at the bottom of the homepage, then approve it in the Admin panel. Or directly edit data/curated/*.txt files in the repo.",
