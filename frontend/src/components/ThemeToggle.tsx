...
const OPTIONS: Option[] = [
  {
    ...
    labelEn: "System",
    labelZh: "跟隨系統",
    icon: <RiComputerLine className="w-3.5 h-3.5" />,
  },
  {
    value: "light",
    labelEn: "Light",
    labelZh: "淺色",
    icon: <RiSunLine className="w-3.5 h-3.5" />,
  },
  {
    value: "dark",
    labelEn: "Dark",
    labelZh: "深色",
    icon: <RiMoonLine className="w-3.5 h-3.5" />,
  },
];
        ...
        >
          ...
          {OPTIONS.map((opt) => (
            ...
            >
              ...
              {setting === opt.value && (
                <RiCheckLine className="w-3.5 h-3.5 shrink-0 text-[var(--ps-neon-cyan)]" />
              )}
            </button>
          ))}
        </div>
